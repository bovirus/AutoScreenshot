...
* Сохранение изображений в формате PNG, JPEG, BMP, TIFF <!--или GIF--> и WEBP
...
* Воспроизведение звука в момент снимка
* Поддержка горячих клавиш
* Работает как в Windows так и в Linux
* Полностью бесплатное ПО с открытым исходным кодом
...
- ЮMoney: [4100 1195 0619 6001](https://yoomoney.ru/to/4100119506196001)
